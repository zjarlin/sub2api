...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID int64, privacyMode string, filters service.AccountListFilters, sortBy, sortOrder string) ([]service.Account, int64, error) {
	...
	s.lastListAccounts.rateMultiplierMin = filters.RateMultiplierMin
	s.lastListAccounts.rateMultiplierMax = filters.RateMultiplierMax
...
func (s *stubAdminService) ListAccountsForSchedulerScoreFilter(_ context.Context, platform, accountType, status, search string, groupID int64, privacyMode string, filters service.AccountListFilters) ([]service.Account, error) {
