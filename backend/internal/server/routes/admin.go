...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/resolve-upstream-key-rate", h.Admin.Account.ResolveUpstreamKeyRate)
		accounts.POST("/test-upstream-console-login", h.Admin.Account.TestUpstreamConsoleLogin)
		...
		accounts.GET("/:id/upstream-key-groups", h.Admin.Account.ListUpstreamKeyGroups)
		accounts.POST("/:id/switch-upstream-key-group", h.Admin.Account.SwitchUpstreamKeyGroup)
