...
const (
	...
	// FieldPersonalAccountScope holds the string denoting the personal_account_scope field in the database.
	FieldPersonalAccountScope = "personal_account_scope"
...
var (
	...
	// DefaultPersonalAccountScope holds the default value on creation for the "personal_account_scope" field.
	DefaultPersonalAccountScope bool
...
// ByPersonalAccountScope orders the results by the personal_account_scope field.
func ByPersonalAccountScope(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPersonalAccountScope, opts...).ToFunc()
}
