...
func (_u *APIKeyUpdate) SetPersonalAccountScope(v bool) *APIKeyUpdate {
	_u.mutation.SetPersonalAccountScope(v)
	return _u
}

// SetNillablePersonalAccountScope sets the "personal_account_scope" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillablePersonalAccountScope(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetPersonalAccountScope(*v)
	}
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.PersonalAccountScope(); ok {
...
// SetPersonalAccountScope sets the "personal_account_scope" field.
func (_u *APIKeyUpdateOne) SetPersonalAccountScope(v bool) *APIKeyUpdateOne {
	_u.mutation.SetPersonalAccountScope(v)
	return _u
}

// SetNillablePersonalAccountScope sets the "personal_account_scope" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillablePersonalAccountScope(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetPersonalAccountScope(*v)
	}
	return _u
