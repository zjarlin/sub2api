...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'doubao' | 'traework' | 'workbuddy' | 'zcode' | 'qoder' | 'laya' | 'jev' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'doubao' | 'traework' | 'workbuddy' | 'zcode' | 'qoder' | 'laya' | 'jev'
