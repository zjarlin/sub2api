            ...
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-3 py-3 text-right font-medium text-emerald-600 dark:text-emerald-400">{{ formatUserCurrency(item.total_rebate) }}</td>
...
async function transferQuota(): Promise<void> {
  ...
  try {
    ...
    appStore.showSuccess(t('affiliate.transfer.success', { amount: formatUserCurrency(resp.transferred_quota) }))
    await Promise.all([
