 ...
 */
export async function getAvailableModels(id: number, options?: { signal?: AbortSignal; timeout?: number }): Promise<ClaudeModel[]> {
  const { data } = await apiClient.get<ClaudeModel[]>(`/admin/accounts/${id}/models`, options)
  return data
}
