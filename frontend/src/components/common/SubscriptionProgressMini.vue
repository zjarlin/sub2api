<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="flex cursor-pointer items-center gap-2 rounded-md border-2 border-black bg-[#ffdc58] px-3 py-1.5 font-bold text-black shadow-[3px_3px_0_#000] transition-all hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none dark:border-white dark:bg-[#7084ff]"
      :title="t('subscriptionProgress.viewDetails')"
    >
      <Icon name="creditCard" size="sm" class="text-black" />
    ...
    <transition name="dropdown">
      <div
        v-if="tooltipOpen"
        class="absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-md border-2 border-black bg-white shadow-[6px_6px_0_#000] dark:border-white dark:bg-dark-800 dark:shadow-[6px_6px_0_#fff]"
      >
        <div class="border-b-2 border-black bg-[#35d9ff] p-3 dark:border-white">
          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <div
                ...
                class="flex items-center gap-2 rounded-md border-2 border-black bg-[#8fff6a] px-2.5 py-1.5 dark:border-white"
              >
