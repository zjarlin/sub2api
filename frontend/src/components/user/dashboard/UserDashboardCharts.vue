<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-green-600 dark:text-green-400">{{ USER_CURRENCY_SYMBOL }}{{ formatCost(model.actual_cost) }}</td>
                  <td class="py-1.5 text-right text-gray-400 dark:text-gray-500">{{ USER_CURRENCY_SYMBOL }}{{ formatCost(model.cost) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <TokenUsageTrend :trend-data="trend" :loading="loading" :currency-symbol="USER_CURRENCY_SYMBOL" />
    </div>
  </div>
</template>
