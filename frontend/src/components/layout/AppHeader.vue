    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:text-gray-900 dark:text-dark-400 dark:hover:text-white sm:flex"
        >
        ...
        <div
          v-if="user"
          class="liquid-surface hidden items-center gap-2 rounded-md border px-3 py-1.5 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-md p-1.5 transition-colors hover:bg-white/50 dark:hover:bg-dark-800/60"
          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              <!-- User Info -->
              <div class="border-b px-4 py-3 liquid-border">
                <div class="text-sm font-medium text-gray-900 dark:text-white">
                  {{ displayName }}
                </div>
              ...
              <!-- Balance (mobile only) -->
              <div class="border-b px-4 py-2 liquid-border sm:hidden">
              ...
              <div
                v-if="contactInfo"
                class="border-t px-4 py-2.5 liquid-border"
              >
              ...
              <div v-if="showOnboardingButton" class="border-t py-1 liquid-border">
              ...
              <div class="border-t py-1 liquid-border">
                <button
                  @click="handleLogout"
