export default {
  ...
  myAccounts: {
    title: '我的账号',
    description: '添加仅供自己 API Key 调度使用的上游账号',
    create: '添加账号',
    edit: '编辑账号',
    searchPlaceholder: '搜索账号名称',
    empty: '暂无个人账号',
    emptyHint: '添加账号后，它只会加入你自己的调度候选，不会进入公共账号池。',
    platform: '平台',
    type: '类型',
    status: '状态',
    name: '名称',
    ...
    privateAccountHint: '这个账号只会加入你自己的调度候选，不会进入公共账号池，管理员和其他用户都不能调度。',
  ...
  keys: {
    ...
    group: '分组',
    noGroup: '无分组',
    personalAccountScope: '我的账号',
    personalAccountScopeHint: '只调度你在“我的账号”页面添加的账号，不使用公共账号池。',
    searchGroup: '搜索分组...',
