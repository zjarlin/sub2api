export default {
  ...
  myAccounts: {
    title: 'My Accounts',
    description: 'Add upstream accounts you maintain that participate in group scheduling',
    create: 'Add Account',
    edit: 'Edit Account',
    searchPlaceholder: 'Search account name',
    empty: 'No personal accounts yet',
    emptyHint: 'After you add an account, it joins scheduling through its selected groups. This page only shows your own accounts.',
    platform: 'Platform',
    type: 'Type',
    status: 'Status',
    name: 'Name',
    ...
    privateAccountHint: 'This account joins scheduling through its selected groups. Other regular users cannot see it on their My Accounts page.',
  ...
  keys: {
    ...
    group: 'Group',
    noGroup: 'No group',
    personalAccountScope: 'My accounts (legacy)',
    personalAccountScopeHint: 'Legacy dedicated personal-account scope. New keys should select a real group.',
  ...
  admin: {
    ...
    accounts: {
      ...
      filterTabs: {
        title: 'Filter Tabs',
        description: 'Built-in tabs cover all / ungrouped / real groups. Custom tabs can combine real-group, display-group, keyword, name-prefix, and advanced regex rules.',
        all: 'All',
        manage: 'Manage Tabs',
        defaultTab: 'Default active tab',
        addTab: 'Add custom tab',
        label: 'Tab label',
        labelPlaceholder: 'e.g. High Priority / Backup Pool',
        realGroup: 'Real group filter',
        noRealGroup: 'No real-group filter',
        displayGroup: 'Display group filter',
        displayGroupPlaceholder: 'Enter a UI display-group name',
        keywordSearch: 'Keyword filter',
        keywordSearchPlaceholder: 'e.g. prod / claude / overseas',
        namePrefix: 'Name prefix',
        namePrefixPlaceholder: 'e.g. prod-',
        searchRegex: 'Advanced regex filter',
        searchRegexPlaceholder: 'e.g. gpt|claude|overseas',
        validationLabel: 'Please enter a tab label',
        validationCondition: 'Configure at least one filter condition',
        validationRegex: 'Invalid regex pattern',
      ...
      allSchedulableStates: 'All Scheduling States',
      ...
      batchTestingProgress: 'Testing {done}/{total}',
      batchTestCurrentPageHint: 'Test accounts on the current page; passing accounts are enabled for scheduling, failed accounts are disabled',
      batchTestAccountsEmpty: 'No accounts on the current page to test',
      batchTestAccountsDone: 'Batch test completed: {passed} passed, {failed} failed',
      batchTestAccountsPartial: 'Batch test completed: {passed} passed, {failed} failed; scheduling update failed for {scheduleFailed} account(s)',
      batchTestAccountsFailed: 'Failed to batch test accounts',
      batchTestNoModel: 'No available test model found',
      batchTestStreamNoBody: 'The test endpoint returned no body',
      batchTestStreamIncomplete: 'The test stream did not return a completion event',
      batchTestTimeout: 'Test timed out',
      ...
      copyAccountSuccess: 'Copied account as {name}',
      ...
      quickOpenAI: {
        ...
        defaultGroupRequired: 'Select a default group in the OpenAI API Key groups first'
      },
      // OpenAI specific hints
      openai: {
        baseUrlHint: 'Leave default for official OpenAI API',
        apiKeyHint: 'Your OpenAI API Key',
        deepseekBaseUrlHint: 'DeepSeek defaults to https://api.deepseek.com and only exposes the OpenAI-compatible chat/completions path; Codex Responses requests are converted by the gateway.',
        ...
        ollamaBaseUrlHint: 'Ollama listens on 11434 by default and exposes a /v1 OpenAI-compatible endpoint; for local deployment you can use http://127.0.0.1:11434/v1.',
        ollamaApiKeyHint: 'Local Ollama usually does not validate an API key, so it can be left empty; if you put auth in front of it, enter that token here.',
        ...
        chatgptWeb2apiBaseUrlHint: 'ChatGPT-Web2API listens on 8080 by default and exposes OpenAI-compatible /v1/chat/completions backed by a logged-in Chrome session.',
        chatgptWeb2apiApiKeyHint: 'Only used when ChatGPT-Web2API api_keys are configured. Otherwise leave empty or use any placeholder token.',
        seedanceBaseUrlHint: 'Seedance uses ModelArk video generation tasks. BytePlus default: https://ark.ap-southeast.bytepluses.com/api/v3; Volcengine China default: https://ark.cn-beijing.volces.com/api/v3.',
        seedanceApiKeyHint: 'ModelArk API key used as a Bearer token for Seedance video generation.',
        ...
        upstreamRate: {
          ...
          reading: 'Testing',
          siteMode: 'Site-to-site mode',
          siteModeHint: 'Log in to the upstream console with this account and detect sub2api/new-api. After saving, the list refreshes this key rate and balance from a 2-hour cache.',
          consoleBaseUrl: 'Upstream Console URL',
          siteType: 'Site Type',
          siteTypeAuto: 'Auto Detect',
          ...
          keysPath: 'Key List Path',
          baseUrlRequired: 'Enter the upstream console URL',
          emailRequired: 'Enter the upstream login username or email',
          passwordRequired: 'Enter the upstream login password',
          apiKeyRequired: 'Enter the target API key to match',
          success: 'Read {site} rate {rate}, group {group}, key {key}',
          failed: 'Failed to read upstream rate',
          loginSuccess: 'Connection ok: {site}, login state {state}, user {user}, balance {balance}',
          loginFailed: 'Failed to test upstream connection',
          siteModeRequired: 'Enable site-to-site mode first',
          groupSwitchNewAPIRequired: 'The current site type does not support upstream group switching',
          targetGroup: 'Target Upstream Group',
          targetGroupPlaceholder: 'For example: GPT low-rate channel',
          groupSwitchHint: 'This logs in to the upstream console and calls the remote endpoint, changing only this key group.',
          groupSwitchSelectedHint: 'Selected {group}, rate {rate}.',
          loadGroups: 'Refresh Groups',
          loadingGroups: 'Loading',
          loadGroupsFailed: 'Failed to load upstream groups',
          groupOptionsEmpty: 'No available upstream groups were returned. You can enter a group name manually.',
          groupSwitch: 'Switch Upstream Group',
          groupSwitching: 'Switching',
          groupNameRequired: 'Enter the target upstream group name',
          groupSwitchSuccess: 'Switched to upstream group {group}',
          groupSwitchFailed: 'Failed to switch upstream group',
          keyRate: 'Key',
          accountRate: 'Account',
          keyGroup: 'Group',
          resolveFailed: 'Read failed'
        },
        vendorOptions: {
          ...
          seedance: 'Seedance / ModelArk',
          gemini: 'Gemini OpenAI',
          mimo: 'Mimo',
          ollama: 'Ollama',
          trae: 'Trae',
          openaiLocalProxy: 'openai-local-proxy',
          chatgptWeb2api: 'ChatGPT-Web2API',
        ...
        endpointCapabilitiesDesc:
          'Used by account routing. The text endpoint follows the Responses API support setting above and is shown as Responses, Chat Completions, or auto mode; Embeddings controls /v1/embeddings; Videos controls /v1/videos/generations.',
        ...
        disablePassthroughForModelRestriction: 'Disable passthrough',
      },
      kiro: {
      ...
      customModelName: 'Bulk add models',
      enterCustomModelName: 'One model per line, or use commas, semicolons, and common delimiters',
      addModel: 'Import models',
      bulkModelInputHint: 'Supports direct multi-line paste, plus commas, semicolons, and common CJK punctuation for bulk import.',
      modelExists: 'Model already exists',
      modelCount: '{count} models',
      bulkImportMappings: 'Bulk import mappings',
      ...
      displayGroupsHint: 'UI-only labels for the admin panel. They do not affect real scheduling groups.',
      poolMode: 'Pool Mode',
      ...
      batchTestModelsStarted: 'Starting batch test for {total} model(s) on account {account}',
      ...
      batchTestingModel: '[{current}/{total}] Testing model: {model}',
      batchTestModelPassed: 'Passed: {model}',
      batchTestModelFailed: 'Failed: {model} - {error}',
      batchTestModelsSummary: 'Batch model test completed: {passed} passed, {failed} failed',
    ...
    ops: {
      ...
      errorLog: {
        ...
        acc: 'ACC:',
        details: 'Details',
        tempDisable: 'Temp Disable',
        tempDisableLoading: 'Disabling',
        tempDisableSuccess: 'Scheduled account {id} temp-disabled for {minutes} minutes',
        tempDisableFailed: 'Failed to temp-disable scheduled account',
        phase: 'Phase',
        id: 'ID:',
