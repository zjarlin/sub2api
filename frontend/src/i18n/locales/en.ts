export default {
  ...
  myAccounts: {
    title: 'My Accounts',
    description: 'Add upstream accounts that only your own API keys can schedule',
    create: 'Add Account',
    edit: 'Edit Account',
    searchPlaceholder: 'Search account name',
    empty: 'No personal accounts yet',
    emptyHint: 'After you add an account, it is available only to your own scheduling candidates, not the public pool.',
    platform: 'Platform',
    type: 'Type',
    status: 'Status',
    name: 'Name',
    ...
    privateAccountHint: 'This account is added only to your own scheduling candidates. It does not enter the public pool, and admins or other users cannot schedule it.',
  ...
  keys: {
    ...
    group: 'Group',
    noGroup: 'No group',
    personalAccountScope: 'My accounts',
    personalAccountScopeHint: 'Dispatch only to accounts you added on the My Accounts page, without using the public account pool.',
