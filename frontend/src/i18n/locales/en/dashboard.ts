export default {
  ...
  keys: {
    ...
    dailyUsageTitle: '{name} - Daily Usage This Month',
    dailyUsageMonthTotal: 'Month Total',
    dailyUsageDate: 'Date',
    dailyUsageRequests: 'Requests',
    dailyUsageInputTokens: 'Input Tokens',
    dailyUsageOutputTokens: 'Output Tokens',
    dailyUsageCacheReadTokens: 'Cache Read',
    dailyUsageCacheWriteTokens: 'Cache Write',
    dailyUsageTotalTokens: 'Total Tokens',
    dailyUsageActualCost: 'Actual Cost',
    dailyUsageEmpty: 'No usage this month',
    dailyUsageLoadFailed: 'Failed to load daily usage details',
    dailyUsageRetry: 'Retry',
    quota: 'Quota',
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        setupScriptHintUnix:
          'macOS / Linux one-click setup script. Copy and run it in a terminal to create ~/.codex and write config.toml; compatibility mode also writes auth.json.',
        setupScriptHintWindows:
          'Windows PowerShell one-click setup script. Copy and run it in PowerShell to create %USERPROFILE%\\.codex and write config.toml; compatibility mode also writes auth.json.',
        setupScriptHintUnixConfigOnly:
          'macOS / Linux one-click setup script. Copy and run it in a terminal to create ~/.codex and write config.toml.',
        setupScriptHintWindowsConfigOnly:
          'Windows PowerShell one-click setup script. Copy and run it in PowerShell to create %USERPROFILE%\\.codex and write config.toml.',
        setupCommandHint:
          'Recommended command: detects the current OS, skips client installation when Codex is already installed, then writes configuration. By default the key is stored in config.toml, so no extra environment variable is required.',
