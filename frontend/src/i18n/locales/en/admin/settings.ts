export default {
  ...
  vision: {
    ...
    curl: {
      ...
      description: 'Supports browser Copy as cURL line continuations, quotes, JSON, GET parameters, and multipart forms. Authentication headers are replaced with a variable in generated output.',
      placeholder: 'curl -X POST https://upstream.example/v1/chat/completions \\\n  -H \'Content-Type: application/json\' \\\n  -d \'{\'{\'}"model":"your-model","messages":[]{\'}{\'}\'',
      parse: 'Parse curl',
      parsed: 'Parsed. Edit each field below before generating.',
      parseFailed: 'Failed to parse curl',
      warnings: '{count} curl options were not fully imported and were ignored.',
    },
    request: {
    ...
    workbench: {
      method: 'Method',
      url: 'URL',
      urlPlaceholder: 'https://gateway.example/v1/systemone',
      headers: 'Headers',
      headersHint: 'Authentication headers are replaced with $SUB2API_KEY in generated output.',
      headerName: 'Header',
      headerValue: 'Value',
      noHeaders: 'No headers',
      query: 'Query parameters',
      queryHint: 'The generated URL is assembled automatically.',
      queryName: 'Name',
      queryValue: 'Value',
      noQuery: 'No query parameters',
      body: 'Body',
      bodyHint: 'JSON keeps its structure; form values use key=value separated by &.',
      formatJson: 'Format JSON',
      invalidJson: 'Invalid JSON',
      jsonPlaceholder: 'model: laya; state: ...',
      formPlaceholder: "image={'@'}photo.jpg&confidence_threshold=0.5",
      bodyMode: {
        none: 'None',
        json: 'JSON',
        form: 'Form',
    ...
    register: {
      title: 'Register as Gateway Model',
      description: 'Candidates contain platform defaults and models mapped by schedulable accounts in the selected group. Saving only updates the group model allowlist.',
      group: 'Target group',
      selectGroup: 'Select a group',
      model: 'Model to register',
      modelPlaceholder: 'For example: laya-multilingual',
      gatewayPath: 'Gateway path',
      keepImportedPath: 'Keep imported URL path',
      useImportedModel: 'Use imported model',
      loadCandidates: 'Load available models',
      availableModels: 'Models from schedulable accounts',
      selectCandidateHint: 'Click a candidate to also update the generated curl model',
      chooseGroupFirst: 'Select a target group first',
      noCandidates: 'No candidates are available for this group',
      replaceHint: 'Replace the existing allowlist (caution). By default, existing models are preserved.',
      register: 'Register model',
      saved: 'Saved to the group model allowlist with {count} models.',
      loadFailed: 'Failed to load available models',
      saveFailed: 'Failed to register model',
      copyCurl: 'Copy generated curl',
    },
    output: {
      title: 'Generated Gateway curl',
      description: 'Uses the current request configuration and replaces the key with $SUB2API_KEY.',
      empty: 'Parse or edit a request to generate a gateway curl here.',
    },
    endpoints: 'Available Endpoints',
    endpointMatrix: 'Endpoint Matrix',
    endpointMatrixDescription: 'Open any tile to inspect the request shape and run a live gateway test.',
    openEndpoint: 'Open endpoint',
    closeDetail: 'Close detail',
    detailTitle: 'Request runner',
    sendRequest: 'Send request',
    sending: 'Sending...',
    responseTitle: 'Response',
    responseEmpty: 'Send the request to inspect the response here.',
    ...
    noApiKeys: 'Create an active API key before sending requests.',
    useImportedRequest: 'Use imported request',
    exampleRequest: 'Load example',
    detailDescription: 'Edit the request like a lightweight Postman, then send it through the gateway.',
