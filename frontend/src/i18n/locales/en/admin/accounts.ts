export default {
    accounts: {
      ...
      qoder: {
        title: 'Qoder',
        connectionHint: 'Calls the official Qoder Model Server (api2-v2.qoder.sh) directly. Enter a Qoder account access token; no Base URL is required.',
        baseUrlHint: 'Not required. The official Qoder Model Server is always used.',
        apiKeyHint: 'Enter the Qoder account access token (bearer token).',
        oauthHint: 'Device-flow authorization',
        oauthDesc: 'Open the Qoder authorization page, sign in and pick an account. This page completes the setup automatically with no token copy/paste.',
        openAuthPage: 'Open Qoder authorization page',
        reopenAuthPage: 'Reopen authorization page',
        waitingAuthorization: 'Waiting for authorization to complete…',
        failedToGenerateUrl: 'Failed to generate the Qoder authorization URL',
        pollFailed: 'Failed to poll the Qoder authorization result',
        authorizationTimeout: 'Authorization timed out. Please start again.',
        testMode: 'Test mode',
        testModeHint: 'Commit-message mode reproduces the request Qoder IDE / CLI uses: POST /model/v1/chat/completions with stream=true and X-Request-ID / X-Session-ID headers.',
        testModeCommitMessage: 'Generate commit message (real contract)',
        testModeDefault: 'Standard connection test',
        diffLabel: 'Git diff (leave blank for the sample diff)',
        diffPlaceholder: 'Paste the git diff to summarize',
        diffHint: 'Calls the official Qoder Model Server with the same body and headers Qoder IDE / CLI use for commit-message generation.',
      },
      laya: {
        title: 'Laya',
      ...
      requestCurl: 'Exact request (cURL, token redacted):',
      ...
      rateMultiplierMin: 'Min multiplier',
      rateMultiplierMax: 'Max multiplier',
      rateMultiplierFilterHint: 'Filter by account multiplier range; leave blank for no bound',
      oauthType: 'OAuth',
