export default {
    ops: {
      ...
      recoveredSuccess: 'Recovered requests',
      recoveredSuccessHint: 'Succeeded after account retry, switching, or model fallback; counted as successful requests.',
      requestErrors: 'Request Errors',
      copyFixPrompt: 'Copy Prompt',
      copyFixPromptCopied: 'Fix prompt copied',
      copyFixPromptNoErrors: 'No error logs in the current window; monitoring data copied. Append error logs manually.',
      ...
      errorLog: {
        ...
        account: 'Account',
        attemptCount: 'Call chain · {count} attempts',
        noRecovered: 'No recovered requests in this window.',
      ...
      errorDetail: {
        ...
        title: 'Error Detail',
        recoveredTitle: 'Recovered request #{id}',
