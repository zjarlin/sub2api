export default {
  dashboard: {
    ...
    periodRequests: '{period}请求',
    periodCost: '{period}消费',
    periodTokens: '{period} Token',
    cacheToday: '今日缓存',
    performance: '性能指标',
    avgResponse: '平均响应',
    averageTime: '平均时间',
  ...
  keys: {
    ...
    month: '本月',
    dailyDetail: '每日明细',
    dailyUsageTitle: '{name} - 本月每日明细',
    dailyUsageMonthTotal: '本月合计',
    dailyUsageDate: '日期',
    dailyUsageRequests: '请求数',
    dailyUsageInputTokens: '输入 Token',
    dailyUsageOutputTokens: '输出 Token',
    dailyUsageCacheReadTokens: '缓存读取',
    dailyUsageCacheWriteTokens: '缓存写入',
    dailyUsageTotalTokens: '总 Token',
    dailyUsageActualCost: '实际消费',
    dailyUsageEmpty: '本月暂无用量',
    dailyUsageLoadFailed: '加载每日用量明细失败',
    dailyUsageRetry: '重试',
    quota: '额度',
    lastUsedAt: '上次使用时间',
    lastUsedIP: '最近使用 IP',
