export default {
    ops: {
      ...
      exceptions: '异常数',
      recoveredSuccess: '降级成功',
      recoveredSuccessHint: '经过账号重试、切换或模型降级后最终成功，计入成功请求。',
      requestErrors: '请求错误',
      copyFixPrompt: '一键复制',
      copyFixPromptCopied: '已复制修复提示词',
      copyFixPromptNoErrors: '当前窗口暂无错误日志，已复制监控数据，请补充报错日志',
      errorCount: '错误数',
      upstreamErrors: '上游错误',
      ...
      errorLog: {
        ...
        account: '账号',
        attemptCount: '调用链 · {count} 次尝试',
        noRecovered: '该窗口内暂无降级成功请求。',
        accountId: '账号 ID',
        status: '状态码',
        message: '响应内容',
        ip: 'IP',
