...
# Install pnpm (pinned to match the lockfile/settings generated by the frontend workspace)
RUN if [ "${SKIP_FRONTEND_BUILD}" != "1" ]; then corepack enable && corepack prepare pnpm@11.7.0 --activate; fi
